...
def move(n_elem, start, end):
    """Move a slice of one stack to the another"""
    starting_stack[end].extend(starting_stack[start][-n_elem:])
    # This is for removing the moved elements from the origin
    starting_stack[start] = starting_stack[start][:-n_elem]
